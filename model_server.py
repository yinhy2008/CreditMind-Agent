...
FEATURE_META = {
    ...
    "open_rv_24m": {"type": "int", "unit": "个", "desc": "24个月内新开循环账户数", "question": "过去 24 个月内，您新开了几张信用卡或循环信用账户？"},
    ...
    "num_tl_op_past_12m": {"type": "int", "unit": "个", "desc": "12个月内新开账户数", "question": "过去 12 个月内，您一共新开了多少个信贷账户（含信用卡、消费贷、分期等所有类型）？"},
    "mo_sin_rcnt_rev_tl_op": {"type": "float", "unit": "月", "desc": "最近开循环账户距今年月", "question": "您最近一次新办信用卡或循环信用账户（如信用额度）是几个月前？"},
    "mo_sin_old_rev_tl_op": {"type": "float", "unit": "月", "desc": "最早开循环账户距今年月", "question": "您最早开的一张信用卡是几个月前？"},
    "mths_since_recent_bc": {"type": "float", "unit": "月", "desc": "最近开银行卡距今年月", "question": "您最近一次在银行新开立银行卡（含银行信用卡、借记卡等）是几个月前？"},
